...
int main()
{sonic;//https://codeforces.com/group/MWSDmqGsZm/contest/223338/problem/M
...
lup(i, 0, N.length()) {
    res *= 10;
    res += (N[i]-'0');
    res %= x;//if this line commented will be convert string to int but the modeulus to make the number fit in long long  
}
